...
Бот для обучения игре в Counter-Strike 2: уроки по основам, экономике, оружию и тактике, карточки с терминами, тесты и статистика прогресса.
...
Контент: основы CS2, экономика (eco/force/full buy), оружие (AK-47, M4, AWP), тактика (entry, trade, peek, utility).
...
- `CARDS` — карточки: `front` (термин) → `back` (значение)
