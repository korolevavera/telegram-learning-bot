(function () {
  ...
  const ICONS = {
    ...
    gurren: '<svg class="gurren" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 1.4C12.6 1.5 12.9 2.7 12.85 4.2 12.8 5 12.9 5.4 13 5.7 13.3 7.1 15 8.4 17.1 9.3 19.3 10.2 20 12 19.6 13.7 19.2 15.1 17.9 16.3 16.2 16.9 15.2 17.4 13.7 18.4 12 18.5 10.3 18.4 8.8 17.4 7.8 16.9 6.1 16.3 4.8 15.1 4.4 13.7 4 12 4.7 10.2 6.9 9.3 9 8.4 10.7 7.1 11 5.7 11.1 5.4 11.2 5 11.15 4.2 11.1 2.7 11.4 1.5 12 1.4z" fill="#b3261a" stroke="#180a07" stroke-width=".55"/><path d="M6.2 8C4.9 7.5 3.3 7.6 2.2 8.3 1.6 8.8 1.3 9.7 1.7 10.4 2.1 11.1 2.8 11.5 3.5 11.4 3.3 11.9 3.2 12.5 3.5 13 4 13.8 4.9 14.2 5.7 13.8 6.4 13.4 7 12.8 7.4 12 7.6 11.5 7.7 10.9 7.6 10.3 7.5 9.5 6.9 8.7 6.2 8z" fill="#b3261a" stroke="#180a07" stroke-width=".55"/><path d="M17.8 8C19.1 7.5 20.7 7.6 21.8 8.3 22.4 8.8 22.7 9.7 22.3 10.4 21.9 11.1 21.2 11.5 20.5 11.4 20.7 11.9 20.8 12.5 20.5 13 20 13.8 19.1 14.2 18.3 13.8 17.6 13.4 17 12.8 16.6 12 16.4 11.5 16.3 10.9 16.4 10.3 16.5 9.5 17.1 8.7 17.8 8z" fill="#b3261a" stroke="#180a07" stroke-width=".55"/><circle cx="9.2" cy="13.8" r="2" fill="#180a07"/><circle cx="14.8" cy="13.8" r="2" fill="#180a07"/><path d="M11.3 16.1L12.7 16.1C12.8 16.3 12.85 16.5 12.8 16.65L12.55 16.9 11.45 16.9 11.2 16.65C11.15 16.5 11.2 16.3 11.3 16.1z" fill="#180a07"/><path d="M8.7 17.4C10 17.1 14 17.1 15.3 17.4 15.7 17.55 15.85 17.95 15.6 18.2 14.75 18.65 13.4 18.85 12 18.85 10.6 18.85 9.25 18.65 8.4 18.2 8.15 17.95 8.3 17.55 8.7 17.4z" fill="#180a07"/><rect x="9.8" y="17.55" width=".9" height=".85" rx=".2" fill="#fff3e0"/><rect x="11.55" y="17.55" width=".9" height=".85" rx=".2" fill="#fff3e0"/><rect x="13.3" y="17.55" width=".9" height=".85" rx=".2" fill="#fff3e0"/></svg>',
