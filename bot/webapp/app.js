(function () {
  ...
  const ICONS = {
    ...
    gurren: '<svg class="gurren" viewBox="0 0 400 400"><defs><linearGradient id="bgGradient" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#1a1a2e;stop-opacity:1" /><stop offset="100%" style="stop-color:#16213e;stop-opacity:1" /></linearGradient><linearGradient id="goldGradient" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style="stop-color:#f9d423;stop-opacity:1" /><stop offset="100%" style="stop-color:#ff4e50;stop-opacity:1" /></linearGradient></defs><circle cx="200" cy="200" r="195" fill="url(#bgGradient)" stroke="#333" stroke-width="5"/><circle cx="200" cy="200" r="180" fill="none" stroke="url(#goldGradient)" stroke-width="4"/><circle cx="200" cy="200" r="150" fill="none" stroke="#f9d423" stroke-width="2" stroke-dasharray="10 5" opacity="0.5"/><circle cx="200" cy="200" r="140" fill="#0f3460" stroke="url(#goldGradient)" stroke-width="3"/><path d="M 120 300 L 200 160 L 280 300" fill="none" stroke="#ffffff" stroke-width="8" stroke-linecap="round"/><path d="M 140 300 L 200 180 L 260 300" fill="none" stroke="#f9d423" stroke-width="4" stroke-linecap="round"/><line x1="135" y1="270" x2="265" y2="270" stroke="#ffffff" stroke-width="6" stroke-linecap="round"/><line x1="155" y1="235" x2="245" y2="235" stroke="#ffffff" stroke-width="6" stroke-linecap="round"/><line x1="175" y1="200" x2="225" y2="200" stroke="#ffffff" stroke-width="6" stroke-linecap="round"/><text x="200" y="130" font-family="Arial, sans-serif" font-size="28" font-weight="bold" fill="url(#goldGradient)" text-anchor="middle" letter-spacing="4">ГУРЕНТАН</text><text x="200" y="340" font-family="Arial, sans-serif" font-size="14" font-weight="normal" fill="#ffffff" text-anchor="middle" letter-spacing="8" opacity="0.7">RAILWAY • ТЕХНОЛОГИИ</text><path d="M 180 160 Q 120 120 100 160 Q 80 200 130 250" fill="none" stroke="#4CAF50" stroke-width="3"/><path d="M 220 160 Q 280 120 300 160 Q 320 200 270 250" fill="none" stroke="#4CAF50" stroke-width="3"/><circle cx="100" cy="160" r="4" fill="#f9d423"/><circle cx="300" cy="160" r="4" fill="#f9d423"/></svg>',
